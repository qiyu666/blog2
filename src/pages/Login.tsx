    ...
    return (
      <div className="auth-page">
        <div className="auth-page__card">
          ...
          <h1 className="auth-page__title">{t('auth.twoFactorTitle')}</h1>
  ...
  return (
    <div className="auth-page">
      <div className="auth-page__card">
        ...
        <p className="auth-page__subtitle">{t('auth.loginSubtitle')}</p>
        ...
        <form onSubmit={handleSubmit} className="auth-page__form">
          <div className="auth-page__field">
            <label className="auth-page__label">{t('auth.usernameOrEmail')}</label>
            <input
